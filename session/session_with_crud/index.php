...
if(isset($_POST['submit'])){
    ...
    if(!empty($id)){
        ...
        if($status == 101){
            header("location: /session/session_with_crud/index.php?task=report&message=$message");
        }else{
            header("location: /session/session_with_crud/index.php?task=edit&id=$id&message=$message");
        }
    }else{
...
<div class="container">
    ...
    if ($task == 'add') {
        ...
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="/session/session_with_crud/index.php?task=add" method="POST">
    ...
    if ($task == 'edit') {
        ...
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="/session/session_with_crud/index.php?task=edit" method="POST">
